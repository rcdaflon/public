...
<html lang="en">
    <head>
        ...
        <title>Anúncios - CRUD</title>
    </head>
    <body>
        <div class="container">  
            <div class="row mb-5">
                <div class="col mt-5 form-group">
                    <a href="../anuncio/adicionar"  class="btn btn-success">+  Cadastrar Novo Anúncio</a>
                </div>
                <div class="col-2">
                </div>
                <div class="col mt-5 form-group">
            ...
            <table class="table w-100">
                <thead class="thead-dark"><tr><th><h3 class="text-center">Lista de Anúncios Cadastrados</h3></th></tr></thead>
            </table>

...
<html lang="en">
    ...
    <body class="text-center">
        <div class="container ">  
            ...
            <form id="usuarioEditForm">
                ...
                <div class="input-group mx-sm-5 mb-5">
                    ...
                    <input type="text" class="form-control" id="telefoneInput" placeholder="somente números">
                </div> 
                <div class="input-group mx-sm-5 mb-5">
                    <div class="input-group-prepend">
                        <span class="input-group-text">Endereço</span>
                    </div>   
                    <input type="text" class="form-control" id="enderecoInput" placeholder="ex.: Rua Antônio de Cássia Filho, 459, Bairro Jardim Santo Antônio, São Paulo, SP.">
                </div>
                <div id="dadosAdm">
                    <div class="input-group mx-sm-5 mb-5">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" id="cpfInput" placeholder="somente números">
                    </div>
                    <div class="input-group mx-sm-5 mb-5">
                        <div class="input-group-prepend">
                            <span class="input-group-text">Banco</span>
                        </div>   
                        <input type="text" class="form-control" id="bancoInput" placeholder="somente números">
                    </div>
                    <div class="input-group mx-sm-5 mb-5">
                        <div class="input-group-prepend">
                            <span class="input-group-text">Agencia</span>
                        </div>   
                        <input type="text" class="form-control" id="agenciaInput" placeholder="somente números">
                    </div>
                    <div class="input-group mx-sm-5 mb-5">
                        <div class="input-group-prepend">
                            <span class="input-group-text">Conta</span>
                        </div>   
                        <input type="text" class="form-control" id="contaInput" placeholder="somente números">
                    </div>
                </div>
        ...
        <script src="../js/usuario/formEditar.js"></script>
    </body>
</html>
...
public class Anuncio {
    ...
    public Anuncio(Long id, Long usuario_id, Double nota, String titulo, String descricao, String laudo_veicular, String formas_pagamento, String status, Integer portas, Integer quantidade_donos, String final_placa, String cor, String motor, Integer ano, String combustivel, Integer kilometragem, String cambio, String modelo, String marca, Double preco, Timestamp data_hora_criacao, Timestamp data_hora_compra, Double taxa_compra, Long protocolo_compra) {
        this.id = id;

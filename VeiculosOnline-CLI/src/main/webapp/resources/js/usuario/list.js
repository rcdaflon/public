...
function load() {
    ...
    xhttp.open("GET", "http://localhost:9005/VeiculosOnline-api/usuario", true);
    xhttp.send();
}

function loadEditForm(){
    //var xhttp = new XMLHttpRequest();
    //xhttp.open("GET", "http://localhost:9005/VeiculosOnline-api/usuario/editar/"+this.id, true);
...
function deleteEntity(){
    ...
    xhttp.open("DELETE", "http://localhost:9005/VeiculosOnline-api/usuario/"+deletarId , true);
    //xhttp.setRequestHeader("Content-type", "application/json");
    xhttp.send();

...
function loadEditForm() {
    ...
    xhttp.open("GET", "http://localhost:9005/VeiculosOnline-api/usuario/" + sessionStorage.getItem('id'), true);
...
function confirmarEditar() {
    ...
    var xhttp = new XMLHttpRequest();
    xhttp.open("PATCH", "http://localhost:9005/VeiculosOnline-api/usuario/" + sessionStorage.getItem('id'), true);
    xhttp.setRequestHeader("Content-type", "application/json");
